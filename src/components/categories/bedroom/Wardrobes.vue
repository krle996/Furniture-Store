    ...
    <div class="article">
      <div class="row">
        ...
        >
          <div class="card my-3">
            <div class="card-body">
              <router-link
                :to="`/proizvodi/spavaća-soba/ormari/${item.id}`"
                class="link"
                tag="div"
              >
      ...
      <div v-if="isAdmin">
        ...
        <b-modal id="insert" hide-footer>
          ...
          <b-button class="mt-3" block variant="success" @click="insertWardrobe"
            >Dodaj</b-button
          >
        </b-modal>
      </div>
...
export default {
  ...
  computed: {
    wardrobes() {
      return this.$store.getters["bedroom/getWardrobes"];
    },
    isAdmin() {
  ...
  created() {
    this.$store.dispatch("bedroom/getWardrobes", {
      limit: 30,
    });
  },
  methods: {
    ...
    insertWardrobe() {
      if (!this.$v.$invalid) {
        ...
        this.$store.dispatch("bedroom/insertWardrobe", this.formData);
        this.clearModal();
    ...
    deleteWardrobe(id) {
      this.$store.dispatch("bedroom/deleteWardrobe", id);
    },
    clearImageUpload() {
