    ...
    <div class="article">
      <div class="row">
        ...
        >
          <div class="card my-3">
            <div class="card-body">
              <router-link
                :to="`/proizvodi/spavaća-soba/komode/${item.id}`"
                class="link"
                tag="div"
              >
      ...
      <div v-if="isAdmin">
        ...
        <b-modal id="insert" hide-footer>
          ...
          <b-button class="mt-3" block variant="success" @click="insertCabinet"
            >Dodaj</b-button
          >
        </b-modal>
      </div>
...
export default {
  ...
  computed: {
    cabinets() {
      return this.$store.getters["bedroom/getCabinets"];
    },
    isAdmin() {
  ...
  created() {
    this.$store.dispatch("bedroom/getCabinets", {
      limit: 30,
    });
  },
  methods: {
    ...
    insertCabinet() {
      if (!this.$v.$invalid) {
        ...
        this.$store.dispatch("bedroom/insertCabinet", this.formData);
        this.clearModal();
    ...
    deleteCabinet(id) {
      this.$store.dispatch("bedroom/deleteCabinet", id);
    },
    clearImageUpload() {
