    ...
    <div class="article">
      <div class="row">
        ...
        >
          <div class="card my-3">
            <div class="card-body">
              <router-link
                :to="`/proizvodi/dnevna-soba/regali/${item.id}`"
                class="link"
                tag="div"
              >
      ...
      <div v-if="isAdmin">
        ...
        <b-modal id="insert" hide-footer>
          ...
          <b-button class="mt-3" block variant="success" @click="insertEC"
            >Dodaj</b-button
          >
        </b-modal>
      </div>
...
export default {
  ...
  computed: {
    eCenters() {
      return this.$store.getters["livingRoom/getECs"];
    },
    isAdmin() {
  ...
  created() {
    this.$store.dispatch("livingRoom/getECs", {
      limit: 30,
    });
  },
  methods: {
    ...
    insertEC() {
      if (!this.$v.$invalid) {
        ...
        this.$store.dispatch("livingRoom/insertEC", this.formData);
        this.clearModal();
    ...
    deleteEC(id) {
      this.$store.dispatch("livingRoom/deleteEC", id);
    },
    clearImageUpload() {
