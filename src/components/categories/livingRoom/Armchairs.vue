    ...
    <div class="article">
      <div class="row">
        ...
        >
          <div class="card my-3">
            <div class="card-body">
              <router-link
                :to="`/proizvodi/dnevna-soba/fotelje/${item.id}`"
                class="link"
                tag="div"
              >
      ...
      <div v-if="isAdmin">
        ...
        <b-modal id="insert" hide-footer>
          ...
          <b-button class="mt-3" block variant="success" @click="insertArmchair"
            >Dodaj</b-button
          >
        </b-modal>
      </div>
...
export default {
  ...
  computed: {
    armchairs() {
      return this.$store.getters["livingRoom/getArmchairs"];
    },
    isAuth() {
  ...
  created() {
    this.$store.dispatch("livingRoom/getArmchairs", {
      limit: 30,
    });
  },
  methods: {
    ...
    insertArmchair() {
      if (!this.$v.$invalid) {
        ...
        this.$store.dispatch("livingRoom/insertArmchair", this.formData);
        this.clearModal();
    ...
    deleteArmchair(id) {
      this.$store.dispatch("livingRoom/deleteArmchair", id);
    },
    clearImageUpload() {
