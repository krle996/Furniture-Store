    ...
    <div class="article">
      <div class="row">
        ...
        >
          <div class="card my-3">
            <div class="card-body">
              <router-link
                :to="`/proizvodi/dnevna-soba/tv-komode/${item.id}`"
                class="link"
                tag="div"
              >
      ...
      <div v-if="isAdmin">
        ...
        <b-modal id="insert" hide-footer>
          ...
          <b-button class="mt-3" block variant="success" @click="insertTVShelf"
            >Dodaj</b-button
          >
        </b-modal>
      </div>
...
export default {
  ...
  computed: {
    TVshelves() {
      return this.$store.getters["livingRoom/getTVShelves"];
    },
    isAuth() {
  ...
  created() {
    this.$store.dispatch("livingRoom/getTVShelves", {
      limit: 30,
    });
  },
  methods: {
    ...
    insertTVShelf() {
      if (!this.$v.$invalid) {
        ...
        this.$store.dispatch("livingRoom/insertTVShelf", this.formData);
        this.clearModal();
    ...
    deleteTVShelf(id) {
      this.$store.dispatch("livingRoom/deleteTVShelf", id);
    },
    clearImageUpload() {
