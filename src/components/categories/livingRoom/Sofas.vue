    ...
    <div class="article">
      <div class="row">
        ...
        >
          <div class="card my-3">
            <div class="card-body">
              <router-link
                :to="`/proizvodi/dnevna-soba/ležajevi/${item.id}`"
                class="link"
                tag="div"
              >
      ...
      <div v-if="isAdmin">
        ...
        <b-modal id="insert" hide-footer>
          ...
          <b-button class="mt-3" block variant="success" @click="insertSofa"
            >Dodaj</b-button
          >
        </b-modal>
      </div>
...
export default {
  ...
  computed: {
    sofas() {
      return this.$store.getters["livingRoom/getSofas"];
    },
    isAuth() {
  ...
  created() {
    this.$store.dispatch("livingRoom/getSofas", {
      limit: 30,
    });
  },
  methods: {
    ...
    insertSofa() {
      if (!this.$v.$invalid) {
        ...
        this.$store.dispatch("livingRoom/insertSofa", this.formData);
        this.clearModal();
    ...
    deleteSofa(id) {
      this.$store.dispatch("livingRoom/deleteSofa", id);
    },
    clearImageUpload() {
