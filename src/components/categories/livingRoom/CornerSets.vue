<template>
  <div>
    ...
    <div class="article">
      <div class="row">
        <div
          v-for="(item, index) in cornerSets"
          :key="index"
        ...
        >
          <div class="card my-3">
            <div class="card-body">
              <router-link
                :to="`/proizvodi/dnevna-soba/ugaone-garniture/${item.id}`"
                class="link"
                tag="div"
              >
...
export default {
  ...
  computed: {
    cornerSets() {
      return this.$store.getters["livingRoom/getCornerSets"];
    },
    isAuth() {
  ...
  created() {
    this.$store.dispatch("livingRoom/getCornerSets", {
      limit: 30,
    });
  },
  methods: {
    ...
    insertCornerSet() {
      if (!this.$v.$invalid) {
        ...
        this.$store.dispatch("livingRoom/insertCornerSet", this.formData);
        this.clearModal();
    ...
    deleteCornerSet(id) {
      this.$store.dispatch("livingRoom/deleteCornerSet", id);
    },
    clearImageUpload() {
