    ...
    <div class="article">
      <div class="row">
        ...
        >
          <div class="card my-3">
            <div class="card-body">
              <router-link
                :to="`/proizvodi/trpezarija/stolovi/${item.id}`"
                class="link"
                tag="div"
              >
      ...
      <div v-if="isAdmin">
        ...
        <b-modal id="insert" hide-footer>
          ...
          <b-button class="mt-3" block variant="success" @click="insertTable"
            >Dodaj</b-button
          >
        </b-modal>
      </div>
...
export default {
  ...
  computed: {
    tables() {
      return this.$store.getters["diningRoom/getTables"];
    },
    isAdmin() {
  ...
  created() {
    this.$store.dispatch("diningRoom/getTables", {
      limit: 30,
    });
  },
  methods: {
    ...
    insertTable() {
      if (!this.$v.$invalid) {
        ...
        this.$store.dispatch("diningRoom/insertTable", this.formData);
        this.clearModal();
    ...
    deleteTable(id) {
      this.$store.dispatch("diningRoom/deleteTable", id);
    },
    clearImageUpload() {
