    ...
    <div class="article">
      <div class="row">
        ...
        >
          <div class="card my-3">
            <div class="card-body">
              <router-link
                :to="`/proizvodi/trpezarija/stolice/${item.id}`"
                class="link"
                tag="div"
              >
      ...
      <div v-if="isAdmin">
        ...
        <b-modal id="insert" hide-footer>
          ...
          <b-button class="mt-3" block variant="success" @click="insertChair"
            >Dodaj</b-button
          >
        </b-modal>
      </div>
...
export default {
  ...
  computed: {
    chairs() {
      return this.$store.getters["diningRoom/getChairs"];
    },
    isAdmin() {
  ...
  created() {
    this.$store.dispatch("diningRoom/getChairs", {
      limit: 30,
    });
  },
  methods: {
    ...
    insertChair() {
      if (!this.$v.$invalid) {
        ...
        this.$store.dispatch("diningRoom/insertChair", this.formData);
        this.clearModal();
    ...
    deleteChair(id) {
      this.$store.dispatch("diningRoom/deleteChair", id);
    },
    clearImageUpload() {
